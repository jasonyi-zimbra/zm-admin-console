...
GlobalConfigXFormView.myXFormModifier = function(xFormObject, entry) {
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.GENERAL_TAB_ATTRS,
        ...
        this.helpMap[_tab1] = [ location.pathname, ZaUtil.HELP_URL, "managing_global_settings/global_settings.htm",
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.ATTACHMENTS_TAB_ATTRS,
        ...
        this.helpMap[_tab2] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/blocking_attachments_to_email.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ]
                .join("");
        tabBarChoices.push({
            value : _tab2,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.MTA_TAB_ATTRS, GlobalConfigXFormView.MTA_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab3] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/mta_smtp_restrictions.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab3,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.IMAP_TAB_ATTRS, GlobalConfigXFormView.IMAP_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab4] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/imap_and_pop_proxy_server.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab4,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.ASAV_TAB_ATTRS, GlobalConfigXFormView.ASAV_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab6] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/anti-spam_protection.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab6,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.INTEROP_TAB_ATTRS,
        ...
        this.helpMap[_tab7] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/making_free_busy_view__available_.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ]
                .join("");
        tabBarChoices.push({
            value : _tab7,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.SKIN_TAB_ATTRS, GlobalConfigXFormView.SKIN_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab8] = [ location.pathname, ZaUtil.HELP_URL, "cos/customizing_ui_themes.htm", "?locid=",
                AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab8,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.BC_TAB_ATTRS, GlobalConfigXFormView.BC_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab9] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/account_email_validation.htm", "?locid=", AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab9,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.AUTH_TAB_ATTRS, GlobalConfigXFormView.AUTH_TAB_RIGHTS)) {
        ...
        this.helpMap[_tab10] = [ location.pathname, ZaUtil.HELP_URL,
                "managing_global_settings/managing_single_sign_on_as_a_global_setting.htm", "?locid=",
                AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab10,
    ...
    if (ZaTabView.isTAB_ENABLED(entry, GlobalConfigXFormView.RETENTION_POLICY_TAB_ATTRS,
        ...
        this.helpMap[_tab11] = [ location.pathname, ZaUtil.HELP_URL, "managing_global_settings/retention_policies.htm",
                "?locid=", AjxEnv.DEFAULT_LOCALE ].join("");
        tabBarChoices.push({
            value : _tab11,
